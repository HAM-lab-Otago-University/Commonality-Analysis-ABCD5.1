...
table_features_no_dup_baseline <- readRDS(paste0(scriptfold,'Common_psy_gene_brain_all/saved_outputs/scatter_plots/table_features_no_dup_baseline_5.1', '.RData'))
table_features_no_dup_followup <- readRDS(paste0(scriptfold,'Common_psy_gene_brain_all/saved_outputs/scatter_plots/table_features_no_dup_followup_5.1', '.RData'))
```
