...
abcd_med_5.1 <-  readRDS(paste0(scriptfold,'Common_psy_gene_brain_all/saved_outputs/performance_metrics/med_info_all_5.1', '.RData'))                  
 ...
 reg_resp <- c("psychopathology_pls","ses_pls") %>% set_names()
...
saveRDS(data_all_baseline,paste0(scriptfold,"Common_psy_gene_brain_all/saved_outputs/common_ses_baseline_5.1.RData"))

saveRDS(data_all_followup,paste0(scriptfold,"Common_psy_gene_brain_all/saved_outputs/common_ses_followup_5.1.RData"))
...
venn_plot_baseline_no_gene_raw <- draw.pairwise.venn_invert(area1 =baseline_no_gene_vec_corrected_raw[1]+baseline_no_gene_vec_corrected_raw[3],
  ...
  category = c("Mental Health","SD LS Dev Adv"),
  fill = c("#D55E00","#999999"),
  lty = "dashed",
  cat.col = c("#D55E00","#999999"),
  filename = NULL,
