...
extract_rf_data <- function(modality_input){
 list_input <-  readRDS(paste0("/Volumes/sci-psy-narun/Nesi/Yue/","stacking_gfactor_10foldcv/collect_enet_results_loaded_gfactor/",modality_input,".enet_results.RDS"))
...
saveRDS(smri_T2_mean_total_data, paste0(nesi_folder,"stacking_gfactor_10foldcv/enet_output_data_loaded_gfactor/smri_T2_mean_total_data.RDS"))
...
saveRDS(smri_T1_mean_total_data, paste0(nesi_folder,"stacking_gfactor_10foldcv/enet_output_data_loaded_gfactor/smri_T1_mean_total_data.RDS"))
...
saveRDS(Normalised_T2_, paste0(nesi_folder,"stacking_gfactor_10foldcv/enet_output_data_loaded_gfactor/Normalised_T2_.RDS"))
...
saveRDS(Avg_T2_Gray_, paste0(nesi_folder,"stacking_gfactor_10foldcv/enet_output_data_loaded_gfactor/Avg_T2_Gray_.RDS"))
...
saveRDS(Avg_T2_White_, paste0(nesi_folder,"stacking_gfactor_10foldcv/enet_output_data_loaded_gfactor/Avg_T2_White_.RDS"))
...
saveRDS(Normalised_T1_, paste0(nesi_folder,"stacking_gfactor_10foldcv/enet_output_data_loaded_gfactor/Normalised_T1_.RDS"))
...
saveRDS(Avg_T1_Gray_, paste0(nesi_folder,"stacking_gfactor_10foldcv/enet_output_data_loaded_gfactor/Avg_T1_Gray_.RDS"))
...
saveRDS(Avg_T1_White_, paste0(nesi_folder,"stacking_gfactor_10foldcv/enet_output_data_loaded_gfactor/Avg_T1_White_.RDS"))
...
saveRDS(Dest_Sulcal_Depth_, paste0(nesi_folder,"stacking_gfactor_10foldcv/enet_output_data_loaded_gfactor/Dest_Sulcal_Depth_.RDS"))
...
saveRDS(Dest_Vol_, paste0(nesi_folder,"stacking_gfactor_10foldcv/enet_output_data_loaded_gfactor/Dest_Vol_.RDS"))
...
saveRDS(Dest_Area_, paste0(nesi_folder,"stacking_gfactor_10foldcv/enet_output_data_loaded_gfactor/Dest_Area_.RDS"))
...
saveRDS(Dest_Thick_, paste0(nesi_folder,"stacking_gfactor_10foldcv/enet_output_data_loaded_gfactor/Dest_Thick_.RDS"))
...
saveRDS(Vol_ASEG_, paste0(nesi_folder,"stacking_gfactor_10foldcv/enet_output_data_loaded_gfactor/Vol_ASEG_.RDS"))
...
saveRDS(Avg_T2_ASEG_, paste0(nesi_folder,"stacking_gfactor_10foldcv/enet_output_data_loaded_gfactor/Avg_T2_ASEG_.RDS"))
...
saveRDS(Avg_T1_ASEG_Vol_, paste0(nesi_folder,"stacking_gfactor_10foldcv/enet_output_data_loaded_gfactor/Avg_T1_ASEG_Vol_.RDS"))
...
saveRDS(rsmri_gordon_aseg_data, paste0(nesi_folder,"stacking_gfactor_10foldcv/enet_output_data_loaded_gfactor/rsmri_gordon_aseg_data.RDS"))
...
saveRDS(rsmri_within_avg_data, paste0(nesi_folder,"stacking_gfactor_10foldcv/enet_output_data_loaded_gfactor/rsmri_within_avg_data.RDS"))
...
saveRDS(incorrectgovsincorrectstop_ROI_, paste0(nesi_folder,"stacking_gfactor_10foldcv/enet_output_data_loaded_gfactor/incorrectgovsincorrectstop_ROI_.RDS"))
...
saveRDS(incorrectgovscorrectgo_ROI_, paste0(nesi_folder,"stacking_gfactor_10foldcv/enet_output_data_loaded_gfactor/incorrectgovscorrectgo_ROI_.RDS"))
...
saveRDS(correctstopvsincorrectstop_ROI_, paste0(nesi_folder,"stacking_gfactor_10foldcv/enet_output_data_loaded_gfactor/correctstopvsincorrectstop_ROI_.RDS"))
...
saveRDS(anystopvscorrectgo_ROI_, paste0(nesi_folder,"stacking_gfactor_10foldcv/enet_output_data_loaded_gfactor/anystopvscorrectgo_ROI_.RDS"))
...
saveRDS(incorrectstopvscorrectgo_ROI_, paste0(nesi_folder,"stacking_gfactor_10foldcv/enet_output_data_loaded_gfactor/incorrectstopvscorrectgo_ROI_.RDS"))
...
saveRDS(correctstopvscorrectgo_ROI_, paste0(nesi_folder,"stacking_gfactor_10foldcv/enet_output_data_loaded_gfactor/correctstopvscorrectgo_ROI_.RDS"))
...
saveRDS(correctgovsfixation_ROI_, paste0(nesi_folder,"stacking_gfactor_10foldcv/enet_output_data_loaded_gfactor/correctgovsfixation_ROI_.RDS"))
...
saveRDS(antiLargeLossVsSmallLoss_ROI_, paste0(nesi_folder,"stacking_gfactor_10foldcv/enet_output_data_loaded_gfactor/antiLargeLossVsSmallLoss_ROI_.RDS"))
...
saveRDS(antiSmallLossVsNeu_ROI_, paste0(nesi_folder,"stacking_gfactor_10foldcv/enet_output_data_loaded_gfactor/antiSmallLossVsNeu_ROI_.RDS"))
...
saveRDS(antiLargeLossVsNeu_ROI_, paste0(nesi_folder,"stacking_gfactor_10foldcv/enet_output_data_loaded_gfactor/antiLargeLossVsNeu_ROI_.RDS"))
...
saveRDS(antiLargeRewVsSmallRew_ROI_, paste0(nesi_folder,"stacking_gfactor_10foldcv/enet_output_data_loaded_gfactor/antiLargeRewVsSmallRew_ROI_.RDS"))
...
saveRDS(antiSmallRewVsNeu_ROI_, paste0(nesi_folder,"stacking_gfactor_10foldcv/enet_output_data_loaded_gfactor/antiSmallRewVsNeu_ROI_.RDS"))
...
saveRDS(antiLargeRewVsNeu_ROI_, paste0(nesi_folder,"stacking_gfactor_10foldcv/enet_output_data_loaded_gfactor/antiLargeRewVsNeu_ROI_.RDS"))
...
saveRDS(feedPunPosVsNeg_ROI_, paste0(nesi_folder,"stacking_gfactor_10foldcv/enet_output_data_loaded_gfactor/feedPunPosVsNeg_ROI_.RDS"))
...
saveRDS(feedRewPosVsNeg_ROI_, paste0(nesi_folder,"stacking_gfactor_10foldcv/enet_output_data_loaded_gfactor/feedRewPosVsNeg_ROI_.RDS"))
...
saveRDS(antiLosVsNeu_ROI_, paste0(nesi_folder,"stacking_gfactor_10foldcv/enet_output_data_loaded_gfactor/antiLosVsNeu_ROI_.RDS"))
...
saveRDS(antiRewVsNeu_ROI_, paste0(nesi_folder,"stacking_gfactor_10foldcv/enet_output_data_loaded_gfactor/antiRewVsNeu_ROI_.RDS"))
...
saveRDS(posfacevsneutface_ROI_, paste0(nesi_folder,"stacking_gfactor_10foldcv/enet_output_data_loaded_gfactor/posfacevsneutface_ROI_.RDS"))
...
saveRDS(negfacevsneutface_ROI_, paste0(nesi_folder,"stacking_gfactor_10foldcv/enet_output_data_loaded_gfactor/negfacevsneutface_ROI_.RDS"))
...
saveRDS(facevsplace_ROI_, paste0(nesi_folder,"stacking_gfactor_10foldcv/enet_output_data_loaded_gfactor/facevsplace_ROI_.RDS"))
...
saveRDS(emotionvsneutface_ROI_, paste0(nesi_folder,"stacking_gfactor_10foldcv/enet_output_data_loaded_gfactor/emotionvsneutface_ROI_.RDS"))
...
saveRDS(X2backvs0back_ROI_, paste0(nesi_folder,"stacking_gfactor_10foldcv/enet_output_data_loaded_gfactor/X2backvs0back_ROI_.RDS"))
...
saveRDS(emotion_ROI_, paste0(nesi_folder,"stacking_gfactor_10foldcv/enet_output_data_loaded_gfactor/emotion_ROI_.RDS"))
...
saveRDS(place_ROI_, paste0(nesi_folder,"stacking_gfactor_10foldcv/enet_output_data_loaded_gfactor/place_ROI_.RDS"))
...
saveRDS(X2back_ROI_, paste0(nesi_folder,"stacking_gfactor_10foldcv/enet_output_data_loaded_gfactor/X2back_ROI_.RDS"))
...
saveRDS(X0back_ROI_, paste0(nesi_folder,"stacking_gfactor_10foldcv/enet_output_data_loaded_gfactor/X0back_ROI_.RDS"))
...
saveRDS(rsmri_subnet, paste0(nesi_folder,"stacking_gfactor_10foldcv/enet_output_data_loaded_gfactor/rsmri_subnet.RDS"))
...
```{r,eval=FALSE}
DTI_data <- extract_rf_data(modality_input = "DTI_data")

saveRDS(DTI_data, paste0(nesi_folder,"stacking_gfactor_10foldcv/enet_output_data_loaded_gfactor/DTI_data.RDS"))

```


# Load all data to create the random forest data



```{r}
part_scan_names <- c("smri_T2_mean_total_data","smri_T1_mean_total_data", "Normalised_T2_", "Avg_T2_Gray_", "Avg_T2_White_", "Normalised_T1_", "Avg_T1_Gray_", "Avg_T1_White_", "Dest_Sulcal_Depth_", "Dest_Vol_", "Dest_Area_", "Dest_Thick_", "Vol_ASEG_", "Avg_T2_ASEG_", "Avg_T1_ASEG_Vol_", "rsmri_gordon_aseg_data", "rsmri_within_avg_data", "incorrectgovsincorrectstop_ROI_", "incorrectgovscorrectgo_ROI_", "correctstopvsincorrectstop_ROI_", "anystopvscorrectgo_ROI_", "incorrectstopvscorrectgo_ROI_", "correctstopvscorrectgo_ROI_", "correctgovsfixation_ROI_", "antiLargeLossVsSmallLoss_ROI_", "antiSmallLossVsNeu_ROI_", "antiLargeLossVsNeu_ROI_", "antiLargeRewVsSmallRew_ROI_", "antiSmallRewVsNeu_ROI_", "antiLargeRewVsNeu_ROI_", "feedPunPosVsNeg_ROI_", "feedRewPosVsNeg_ROI_", "antiLosVsNeu_ROI_", "antiRewVsNeu_ROI_", "posfacevsneutface_ROI_", "negfacevsneutface_ROI_", "facevsplace_ROI_", "emotionvsneutface_ROI_", "X2backvs0back_ROI_", "emotion_ROI_","place_ROI_", "X2back_ROI_", "X0back_ROI_","DTI_data","rsmri_subnet")


scan_enet_pred_list <- map(part_scan_names,~readRDS(paste0(nesi_folder,"/stacking_gfactor_10foldcv/enet_output_data_loaded_gfactor/",.,".RDS")))

names(scan_enet_pred_list) <- part_scan_names

fold_names_data <- names(scan_enet_pred_list[["smri_T1_mean_total_data"]][["random_forest_data_list"]]) %>% set_names()
```
...
random_forest_data_cross_site <- function(list_input= rf_baseline_train, fold_input){
  one_fold_list <- map(list_input,fold_input)
  one_fold_tibble <- plyr::join_all(one_fold_list,by = subj_info,type = "full")
  return(one_fold_tibble)
}

random_forest_baseline_train <- map(.x = fold_names_data,~random_forest_data_cross_site(fold_input = .))

random_forest_baseline_test <- map(.x = fold_names_data,~random_forest_data_cross_site(list_input =rf_baseline_test,fold_input = .))

random_forest_followup_train <- map(.x = fold_names_data,~random_forest_data_cross_site(list_input =rf_followup_train,fold_input = .))

random_forest_followup_test <- map(.x = fold_names_data,~random_forest_data_cross_site(list_input =rf_followup_test,fold_input = .))
...
saveRDS(random_forest_baseline_test, paste0(nesi_folder,"stacking_gfactor_10foldcv/random_forest_data/random_forest_all_baseline_test_fold.RDS"))

saveRDS(random_forest_followup_test, paste0(nesi_folder,"stacking_gfactor_10foldcv/random_forest_data/random_forest_all_followup_test_fold.RDS"))
```


```{r}
feature_names <- random_forest_baseline_train[[1]]%>% select(-all_of(subj_info))%>% names()
...
random_forest_site_large <- random_forest_baseline_train %>% map(.,~replace_na_tibble(data_input = ., na_replace = 1000,na_repace_name = "large"))

random_forest_site_small <- random_forest_baseline_train %>% map(.,~replace_na_tibble(data_input = ., na_replace = -1000,na_repace_name = "small"))

random_forest_site_large_baseline_test <- random_forest_baseline_test %>% map(.,~replace_na_tibble(data_input = ., na_replace = 1000,na_repace_name = "large"))

random_forest_site_small_baseline_test <- random_forest_baseline_test %>% map(.,~replace_na_tibble(data_input = ., na_replace = -1000,na_repace_name = "small"))

random_forest_site_large_followup_train <- random_forest_followup_train %>% map(.,~replace_na_tibble(data_input = ., na_replace = 1000,na_repace_name = "large"))

random_forest_site_small_followup_train <- random_forest_followup_train %>% map(.,~replace_na_tibble(data_input = ., na_replace = -1000,na_repace_name = "small"))

random_forest_site_large_followup_test <- random_forest_followup_test %>% map(.,~replace_na_tibble(data_input = ., na_replace = 1000,na_repace_name = "large"))

random_forest_site_small_followup_test <- random_forest_followup_test %>% map(.,~replace_na_tibble(data_input = ., na_replace = -1000,na_repace_name = "small"))
...
```{r}
join_gfactor <- function(fold_input,
                         gfactor_data_input=gfactor_baseline_train,
                         random_forest_data_input=random_forest_baseline_features){
  gfactor_input <- gfactor_data_input[[fold_input]]
  random_forest_input <- random_forest_data_input[[fold_input]]
  data_output <- left_join(random_forest_input,gfactor_input,by = "SRC_SUBJECT_ID")
  return(data_output)
}

random_forest_gfactor <- fold_names_data %>% map(.,~join_gfactor(fold_input = .))

random_forest_gfactor_baseline_test <- fold_names_data %>% map(.,~join_gfactor(fold_input = .,
                                                                gfactor_data_input=gfactor_baseline_test,
                                                                random_forest_data_input=random_forest_baseline_test_features))

random_forest_gfactor_followup_train <- fold_names_data %>% map(.,~join_gfactor(fold_input = .,
                                                                gfactor_data_input=gfactor_followup_train,
                                                                random_forest_data_input=random_forest_followup_features))

random_forest_gfactor_followup_test <- fold_names_data %>% map(.,~join_gfactor(fold_input = .,
...
saveRDS(random_forest_gfactor, paste0(nesi_folder,"stacking_gfactor_10foldcv/random_forest_data/random_forest_gfactor_train_baseline.RDS"))

saveRDS(random_forest_gfactor_baseline_test, paste0(nesi_folder,"stacking_gfactor_10foldcv/random_forest_data/random_forest_gfactor_baseline_test.RDS"))

saveRDS(random_forest_gfactor_followup_train, paste0(nesi_folder,"stacking_gfactor_10foldcv/random_forest_data/random_forest_gfactor_followup_train.RDS"))

saveRDS(random_forest_gfactor_followup_test, paste0(nesi_folder,"stacking_gfactor_10foldcv/random_forest_data/random_forest_gfactor_followup_test.RDS"))
...
saveRDS(random_forest_baseline, paste0(nesi_folder,"stacking_gfactor_10foldcv/random_forest_data/random_forest_baseline.RDS"))

saveRDS(random_forest_followup, paste0(nesi_folder,"stacking_gfactor_10foldcv/random_forest_data/random_forest_followup.RDS"))
```


```{r}

enet_pred_values <- function(fold_input = fold_names_data[1],
                             data_input = random_forest_baseline){
  train_input <- data_input[["train_list"]][[fold_input]]%>%
                 select(all_of(subj_info),ends_with("_large"))%>% 
                 naniar::replace_with_na_all(condition = ~.x == 1000)%>%
                 mutate(fold = "train")
  data_all_names <- colnames(train_input)  
  data_all_names_cleaned <- str_remove_all(data_all_names,"_large")
  test_input <- data_input[["test_list"]][[fold_input]]%>%
                 select(all_of(subj_info),ends_with("_large"))%>% 
                 naniar::replace_with_na_all(condition = ~.x == 1000)%>%
                 mutate(fold = "test")
  
  data_output <- bind_rows(train_input,test_input)
  
  names(data_output) <- data_all_names_cleaned
  
  return(data_output)
}

enet_pred_baseline <- map(fold_names_data,~enet_pred_values(fold_input = .))

enet_pred_followup <- map(fold_names_data,~enet_pred_values(fold_input = .,
                                                      data_input = random_forest_followup))
...
map2(.x = enet_pred_baseline, .y = fold_names_data,
     ~write_csv(.x, paste0(nesi_folder,"stacking_gfactor_10foldcv/random_forest_data/enet_pred_baseline_",.y,".csv"))
)


map2(.x = enet_pred_followup, .y = fold_names_data,
     ~write_csv(.x, paste0(nesi_folder,"stacking_gfactor_10foldcv/random_forest_data/enet_pred_followup_",.y,".csv"))
)
