...
id_list <- readRDS(paste0(scriptfold,'Common_psy_gene_brain_all/saved_outputs/performance_metrics/gene_idlist', '.RData'))

uncorrected_id <- id_list$uncorrected_id

corrected_id <- id_list$corrected_id
