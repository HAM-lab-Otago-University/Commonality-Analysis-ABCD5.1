...
gfactor_ses <- readRDS(paste0(scriptfold,'genetics_psychopathology_common_scan_all_scripts/ses_pls_pred_5.1', '.RData'))
...
brain_performance_metric <- readRDS(paste0(scriptfold,'Common_psy_gene_brain_all/saved_outputs/performance_metrics/brain_performance_metric_5.1', '.RData'))

gene_performance_metric <- readRDS(paste0(scriptfold,'Common_psy_gene_brain_all/saved_outputs/performance_metrics/gene_performance_metric_5.1', '.RData'))

mental_health_performance_metric <- readRDS(paste0(scriptfold,'Common_psy_gene_brain_all/saved_outputs/performance_metrics/mental_health_performance_metric_no_asr_5.1', '.RData'))

ses_performance_metric <- readRDS(paste0(scriptfold,'Common_psy_gene_brain_all/saved_outputs/performance_metrics/ses_performance_metric_5.1', '.RData'))


set_of_brain_features_performance_metric <- readRDS(paste0(scriptfold,'Common_psy_gene_brain_all/saved_outputs/performance_metrics/set_of_brain_features_performance_metric_5.1', '.RData'))
```
...
psy_seperate_plot_baseline <- readRDS(paste0(scriptfold,'Common_psy_gene_brain_all/saved_outputs/scatter_plots/psy_seperate_plot_baseline_no_asr_5.1', '.RData'))

psy_seperate_plot_followup <- readRDS(paste0(scriptfold,'Common_psy_gene_brain_all/saved_outputs/scatter_plots/psy_seperate_plot_followup_no_asr_5.1', '.RData'))
...
```{r}
names_vec <- c("Neuroimaging", "Mental Health", "Polygenic Scores", "S-D LS Dev Adv")
...
scatter_baseline_mental_health <- vector("list",length = 3)

scatter_baseline_mental_health[[1]] <- scatter_plot_baseline_new[[2]]
scatter_baseline_mental_health[[2]] <- psy_seperate_plot_baseline[[1]]
scatter_baseline_mental_health[[3]] <- psy_seperate_plot_baseline[[2]]
...
scatter_followup_mental_health <- vector("list",length = 3)

scatter_followup_mental_health[[1]] <- scatter_plot_followup_new[[2]]
scatter_followup_mental_health[[2]] <- psy_seperate_plot_followup[[1]]
scatter_followup_mental_health[[3]] <- psy_seperate_plot_followup[[2]]
...
```{r,eval=FALSE}
scatter_plot_baseline_5.1 <- list(scatter_plot_baseline_new$psy,
                                  scatter_plot_baseline_new$rf,
                                  scatter_plot_baseline_new$gene,
                                  scatter_plot_baseline_new$ses)

scatter_plot_followup_5.1 <- list(scatter_plot_followup_new$psy,
                                  scatter_plot_followup_new$rf,
                                  scatter_plot_followup_new$gene,
                                  scatter_plot_followup_new$ses)

saveRDS(scatter_plot_baseline_5.1,paste0(scriptfold,'Common_psy_gene_brain_all/saved_outputs/scatter_plots/scatter_plot_baseline_5.1', '.RData'))
saveRDS(scatter_plot_followup_5.1,paste0(scriptfold,'Common_psy_gene_brain_all/saved_outputs/scatter_plots/scatter_plot_followup_5.1', '.RData'))
```
...
labelled_scatter_all <- ggpubr::annotate_figure(scatter_all_grid,
                          left= ggpubr::text_grob("Observed Cognitive Abilities (Z)",size=45,rot=90),
                        bottom = ggpubr::text_grob("Predicted Cognitive Abilities (Z)",size=45),
                        top = ggpubr::text_grob("Performance of the Neuroimaging, Polygenic Scores and Social-Demographics, \nLifestyles and Developments in Predicting Cognitive Abilities",size=50, face = "bold")) 
...
scatter_baseline_brain_gene <- scatter_baseline_all[1:2]
scatter_followup_brain_gene <- scatter_followup_all[1:2]


scatter_baseline_grid_brain_gene <-ggpubr::ggarrange(plotlist = scatter_baseline_brain_gene,
                                                        #common.legend = TRUE,
                                              ncol = 2,nrow = 1
                                              #,
                                              #          legend.grob = scatter_legend,
                ...
                ggpubr::annotate_figure(top = ggpubr::text_grob("Baseline",face="bold",size=45,hjust=2.4))
#%>%
  #ggpubr::ggarrange(legend.grob = scatter_legend,
  #legend="top")

scatter_followup_grid_brain_gene <-ggpubr::ggarrange(plotlist = scatter_followup_brain_gene,
                                                        ncol = 2,nrow = 1)%>%
                  ggpubr::annotate_figure(top = ggpubr::text_grob("Followup",face="bold",size=45,hjust=2.26))


scatter_grid_brain_gene <- ggpubr::ggarrange(scatter_baseline_grid_brain_gene,
                                             scatter_followup_grid_brain_gene,
                                             ncol = 2,nrow = 1,legend.grob = scatter_legend,legend="top")

labelled_scatter_brain_gene <- ggpubr::annotate_figure(scatter_grid_brain_gene,
                          left= ggpubr::text_grob("Observed Cognitive \nAbilities (Z)",size=45,rot=90),
                        bottom = ggpubr::text_grob("Predicted Cognitive Abilities (Z)",size=45),
                        top = ggpubr::text_grob("Performance of Neuroimaging Measures and Polygenic Scores in \nPredicting Cognitive Abilities",size=45, face = "bold")) 

labelled_scatter_brain_gene

labelled_scatter_brain_gene_notitle <- ggpubr::annotate_figure(scatter_grid_brain_gene,
                          left= ggpubr::text_grob("Observed Cognitive \nAbilities (Z)",size=45,rot=90),
                        bottom = ggpubr::text_grob("Predicted Cognitive Abilities (Z)",size=45)) 

labelled_scatter_brain_gene_notitle
```
Combining the social economics lifestyle developmental plot

```{r,fig.width=23,fig.height=6}

scatter_baseline_socio <- scatter_baseline_all[[3]]
scatter_followup_socio <- scatter_followup_all[[3]]

scatter_baseline_grid_socio <-ggpubr::ggarrange(scatter_baseline_socio,
                                                        #common.legend = TRUE,
                                              ncol = 2,nrow = 1
                                              #,
                                              #          legend.grob = scatter_legend,
                ...
                ggpubr::annotate_figure(top = ggpubr::text_grob("Baseline",face="bold",size=45,hjust=1.51))
#%>%
  #ggpubr::ggarrange(legend.grob = scatter_legend,
  #legend="top")

scatter_followup_grid_socio <-ggpubr::ggarrange(scatter_followup_socio,
                                                        ncol = 2,nrow = 1)%>%
                  ggpubr::annotate_figure(top = ggpubr::text_grob("Followup",face="bold",size=45,hjust=1.45))


scatter_grid_socio <- ggpubr::ggarrange(scatter_baseline_grid_socio,
                                             scatter_followup_grid_socio,
                                             ncol = 2,nrow = 1,legend.grob = scatter_legend_right,legend="right")

labelled_scatter_socio <- ggpubr::annotate_figure(scatter_grid_socio,
                          left= ggpubr::text_grob("Observed Cognitive \nAbilities (Z)",size=45,rot=90),
                        bottom = ggpubr::text_grob("Predicted Cognitive Abilities (Z)",size=45),
                        top = ggpubr::text_grob("Performance of Socio-Demographics, Lifestyles and Developments \nIn Predicting Cognitive Abilitiess",size=45, face = "bold")) 

labelled_scatter_socio


labelled_scatter_socio_notitle <- ggpubr::annotate_figure(scatter_grid_socio,
                          left= ggpubr::text_grob("Observed Cognitive \nAbilities (Z)",size=45,rot=90),
                        bottom = ggpubr::text_grob("Predicted Cognitive Abilities (Z)",size=45)) 



labelled_scatter_socio_notitle
